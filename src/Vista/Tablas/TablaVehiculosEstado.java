 ...
 * @author ASUS
 */
public class TablaVehiculosEstado extends AbstractTableModel{
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2: return (persona.isEstadoPersona() == true) ? "HABILTADO" : "DESHABILITADO";
            case 3: return vehiculo.getPlaca();
            case 4: return vehiculo.getModelo();
            case 5: return vehiculo.getColor();
            case 6: return (vehiculo.isEstadoVehiculo() == true) ? "HABILTADO" : "DESHABILITADO";
            default: return null;
        }
    }
    ...
    public String getColumnName(int column) {
        switch (column) {
            ...
            case 2: return "Estado Propietario";
            case 3: return "Placa";
            case 4: return "Modelo";
            case 5: return "Color";
            case 6: return "Estado Vehiculo";
            default: return null;
        }
    }
